...
let wrapped = mochaPlugin.getWrapper('add_five', '/src/add_five/index.js', 'handler');
const add_five = require(process.env.SERVERLESS_TEST_ROOT + '/src/add_five/add_five.js')
